...
namespace TMPro.Examples
{
    ...
    public class TMP_UiFrameRateCounter : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            m_TextMeshPro.font = Recursos.Load<TMP_FontAsset>("Fonts & Materials/LiberationSans SDF");
            m_TextMeshPro.fontSharedMaterial = Recursos.Load<Material>("Fonts & Materials/LiberationSans SDF - Overlay");
