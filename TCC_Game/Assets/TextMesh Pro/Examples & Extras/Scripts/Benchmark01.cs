    ...
    public class Benchmark01 : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                m_material02 = Recursos.Load<Material>("Fonts & Materials/LiberationSans SDF - Drop Shadow"); // Make sure the LiberationSans SDF exists before calling this...  
            ...
            else if (BenchmarkType == 1) // TextMesh
            {
                ...
                {
                    m_textMesh.font = Recursos.Load("Fonts/ARIAL", typeof(Font)) as Font;
                    m_textMesh.GetComponent<Renderer>().sharedMaterial = m_textMesh.font.material;
                }
